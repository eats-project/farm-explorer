	...
	public static String parseDataInJSONLD (MultipartFile file , String sensorIRI) {
		String json = "{\"@graph\":[";
		  ...
		  try (InputStreamReader reader = new InputStreamReader(file.getInputStream());
	            ...
	            String namespace = sensorIRI+":SoilTemp:Observation:";
	           
	            for (CSVRecord record : parser) {
	          
	            String timestamp =Utils.convertTimestamp(record.get(headers.get(0)));
	            
	             String reading = record.get("Soil Temperature:").replaceAll("[^0-9.]", "");;
	             ...
	             json = json + "{\"@id\":\""+namespace+timestamp+"\","
	             		...
	             		+ "     \"http://www.w3.org/ns/sosa/resultTime\":\""+timestamp+"\","
	             				...
	             				+ "	\"http://qudt.org/schema/qudt/unit\":{\"@id\":\"http://www.wikidata.org/entity/Q25267\"},"
	             				+ "	\"http://qudt.org/schema/qudt/hasQuantityKind\":{\"@id\":\"http://www.wikidata.org/entity/Q11466\"},"
